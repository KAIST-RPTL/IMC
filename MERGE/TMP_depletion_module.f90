...
module depletion_module 
    ...
    subroutine getENDFdepletionlibrary
        ...
        ! %FRAC: Fraction of each reactions
        ! %daughter: Resulting nuclide
        ...
        if (n_react==0) go to 15 ! 15: NEXT NUCLIDE
                ...
                do i = 1,nfssn
                    ...
                    if(nE==0) then
                        ...
                        if(nE==1) then
                            ...
                            if(imat == 1) print *, fssn_zai(i), zai, aceval
                            do j = 1,ngrid

module bank_header 
    ...
    type :: Bank
        ...
        ! ====== 211227, ADJOINT ===== BANK
        ! SERPENT METHOD: accumulate delayed/life of neutron for gamma = 10
    ...
    ! 211227, ADJOINT SOURCE INIT
    type(Bank), allocatable, target :: source_bank_init(:)
    type(Bank), allocatable, target :: delayed_bank_init(:)
